...
export default function Packages() {
  const packages = [
  {
    ...
    subtitle: "Perfect for everyday laundry with reliable next-day service.",
    price: "Rp25.000",
    unit: "/Kg",
    featured: false,
    badge: "",
  ...
  },
  {
    ...
    subtitle: "Fast and convenient for busy schedules.",
    price: "Rp30.000",
    unit: "/Kg",
    featured: false,
    badge: "",
  ...
  },
  {
    ...
    subtitle: "Ideal when you need your laundry back the same day.",
    price: "Rp35.000",
    unit: "/Kg",
    featured: true,
    badge: "Most Popular",
  ...
  },
  {
    ...
    subtitle: "Priority express handling for urgent laundry needs.",
    price: "Rp40.000",
    unit: "/Kg",
    featured: false,
    badge: "Fast Service",
  ...
  {
    title: "Express 4 Hours",
    subtitle: "Our fastest premium laundry service.",
    price: "Rp45.000",
    unit: "/Kg",
    featured: false,
    badge: "Quickest",
    features: [
      "4 Hours Express Service",
      "Free Pickup & Delivery",
      "Complete Wash, Drying & Ironing",
      "Premium Service & Premium Detergent",
      "One Machine, One Customer",
